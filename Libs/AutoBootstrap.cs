...
namespace DouSlackingMonitor.Libs
{
    public class AutoBootstrap
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "DouSlackingMonitor";
        private const string QuickDescription = "Dou Slacking Monitor 用于监听当前设备状态";
        ...
        public void SetMeAutoStart(bool onOff = true)
        {
            if (onOff)//开机启动
            {
                ...
                {
                    CreateShortcut(SystemStartPath, QuickName, AppAllPath, QuickDescription);
                }
            }
            else//开机不启动
            {
        ...
        public void CreateDesktopQuick(string desktopPath = "", string quickName = "", string appPath = "")
        {
            ...
            {
                CreateShortcut(desktopPath, quickName, appPath, QuickDescription);
            }
        }
    }
